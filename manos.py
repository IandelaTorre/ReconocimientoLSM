...
nombre = 'letraA'
direccion = 'C:/Users/IandelaTorre/Documents/Entrenamiento/Validacion'
...
manos = clase_manos.Hands(static_image_mode = False,
    max_num_hands = 1,
    min_detection_confidence = 0.5) #Primer parametro, FALSE para que no haga la deteccion 24/7
